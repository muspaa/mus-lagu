...
export default async function handler(req, res) {
    // 1. Set header untuk mengizinkan akses dari berbagai sumber
    ...
    try {
        // 2. Kirim POST request ke endpoint internal YouTube
            ...
            body: JSON.stringify({
                context: {
                    client: {
                        ...
                        hl: 'id' // 'id' untuk Bahasa Indonesia, ganti ke 'en' jika perlu
                    }
                },
                query: query,
                part: 'snippet'
        ...
        // 3. Parsing dan format data dari response Innertube
